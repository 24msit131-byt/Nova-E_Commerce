...
const ContactUs = () => {
    ...
    const [formData, setFormData] = useState({
        ...getContactDefaults(user || getStoredUser()),
        subject: '',
        message: ''
    });
        ...
        const loadProfileData = async () => {
            try {
                ...
                if (isMounted && profileUser) {
                    setFormData((prev) => ({
                        ...prev,
                        ...getContactDefaults(profileUser)
                    }));
                }
            } catch {
                ...
                if (isMounted && fallbackUser) {
                    setFormData((prev) => ({
                        ...prev,
                        ...getContactDefaults(fallbackUser)
                    }));
                }
            }
        };
        ...
        <div className="min-h-screen pt-24 pb-0 w-full overflow-x-hidden" style={{ backgroundColor: colors.pageBg }}>
            ...
            <section className="w-full px-6 md:px-10 -mt-16 relative z-20">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        { icon: <FaPhoneAlt />, title: "Concierge Line", detail: "+91 9909205515", sub: "Mon-Sat, 9am - 6pm" },
                        { icon: <FaEnvelope />, title: "Digital Inquiry", detail: "rahulkprajapati1@gmail.com", sub: "24/7 Digital Support" },
                        { icon: <FaMapMarkerAlt />, title: "Our Location", detail: "Ahmedabad, Gujarat", sub: "Artisan District, S.G." },
                        { icon: <FaClock />, title: "Open Hours", detail: "10:00 - 19:00", sub: "Sunday -  Sanctuary" }
                    ].map((item, i) => (
                    ...
                    <form className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16" onSubmit={handleSubmit}>
                        ...
                        <div className="md:col-span-2 pt-6 flex flex-col sm:flex-row gap-4">
                            <button 
                                ...
                                className="px-12 py-5 text-white text-[10px] font-black uppercase tracking-[0.3em] rounded-full shadow-2xl transition-all duration-500 flex items-center justify-center group active:scale-95 flex-1 disabled:opacity-70 disabled:cursor-not-allowed"
                            ...
                            <a 
                                href="https://wa.me/919909205515" /*9876543210*/ 
                                target="_blank" 
                ...
                <div className="w-full h-[650px] rounded-[4rem] relative overflow-hidden border shadow-2xl flex flex-col lg:flex-row" style={{ borderColor: colors.accent }}>
                    ...
                    <div className="lg:w-[350px] h-full bg-white z-20 border-r p-12 flex flex-col justify-between" style={{ borderColor: colors.accent }}>
                        <div className="space-y-10">
                            <div>
                                <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-50 text-[9px] font-black uppercase tracking-widest text-green-600 mb-4 animate-pulse">
                                    <span className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse"></span> Open Now
                                </div>
                                <h3 className="text-3xl font-black uppercase tracking-tighter" style={{ color: colors.textMain }}><span style={{color: colors.primary}}>N</span>ova.</h3>
                                <h3 className="text-3xl font-black uppercase tracking-tighter" style={{ color: colors.textMain }}>Home Care</h3>
                    ...
                    <div className="flex-1 h-full relative bg-[#F2EBDD]">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                            <div className="text-center p-12 rounded-[3rem] bg-white/90 backdrop-blur-xl shadow-2xl border max-w-sm" style={{ borderColor: colors.accent }}>
                                ...
                                <a 
                                    href="https://www.google.com/maps?q=22.540770,72.926283" 
                                    target="_blank" 
                                    rel="noreferrer"
